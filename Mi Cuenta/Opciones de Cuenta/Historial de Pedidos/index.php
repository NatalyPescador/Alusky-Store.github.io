                ...
                <div class="account_section_container">
                    <div class="left_nav_bar">
                        <ul class="left_list">
                            ...
                            <li><a href="index.php" class="main_page">Historial de pedidos</a></li>
                            <li><a href="../Mis Imagenes/index.php">Mis Imagenes</a></li>
                            <li><a href="../Información de Cuenta/index.php">Información de la cuenta</a></li>
                    ...
                    <div class="top_nav_bar">
                        <p><a href="../../index.html">Mi cuenta </a><span>></span><a href="index.html"> Historial de pedidos</a></p>
