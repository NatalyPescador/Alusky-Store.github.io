                ...
                <div class="header_container">
                    <div class="top_header">
                        ...
                        <div class="right_header">
                            <button onclick="location.href='../../../Iniciar Sesion/index.html'" class="sign_in_button">Cerrar Sesión</button>
            ...
            <section>
                <div class="account_section_container">
                    ...
                    <div class="top_nav_bar">
                        <p><a href="../../index.html">Mi cuenta </a><span>></span><a href="index.html"> Información de la cuenta</a></p>
                        <h2>Información de la cuenta</h2>
                    </div>
                    <div class="main_section">
                        <div class="info_container">
                            <label for="current_email" class="label">Correo electrónico actual</label>
                            <input type="email" name="current_email" id="current_email" class="input bottom_margin">
                            <label for="name" class="label">Nombre</label>
                            <input type="text" name="name" id="name" class="input bottom_margin">
                            <label for="lastname" class="label">Apellidos</label>
                            <input type="text" name="lastname" id="lastname" class="input bottom_margin">
                            <label for="cel" class="label">Celular</label>
                            <input type="text" name="cel" id="cel" class="input bottom_margin">
                            <label for="backup_email" class="label">Correo electrónico de respaldo</label>
                            <input type="text" name="backup_email" id="backup_email" class="input bottom_margin">
                            <button class="button_section">Guardar cambios</button>
                        </div>
                    </div>      
                </div>
            </section>
