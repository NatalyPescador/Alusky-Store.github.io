...
$lista = $objMetodos->ListarCamisetasCod($codigo);
...
<body>
    ...
    <main>
        <button type="button" class="back_button" onclick="location.href='Camisetas.php'">
        ...
        <div class="product_details_container">
            ...
            <div class="right_info_container">
                ...
                <div class="form_info_container">
                    <form action="Detalles_Camisetas.php?codigo=<?php echo $codigo; ?>" method="post">
