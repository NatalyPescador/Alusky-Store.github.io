            ...
            <section class="forgot_password">
                <div class="forgot_password_container">
                    <form class="forgot_password_form" method="post" action="correoContrasena.php">
                        ...
                        <h2>No te preocupes, es posible recuperarla</h2>
                        <input id="email_forgot_password" type="email" placeholder="Correo electrónico" name="correo" required>
                        <div class="links">
                            <a href="../Registrarse/index.html">¿No tienes una cuenta? Registrate</a>
                        </div>
